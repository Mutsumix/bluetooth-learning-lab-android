...
fun BottomNavigationBar(navController: NavController) {
    val tabs = listOf(
        TabItem(Screen.Home.route, "🏠", "ホーム"),
        TabItem(Screen.Scale.route, "⚖️", "Scale"),
        TabItem(Screen.Printer.route, "🖨️", "Printer"),
        TabItem(Screen.EPaper.route, "📄", "E-Paper"),
        TabItem(Screen.Log.route, "📋", "ログ")
    )
